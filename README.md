...
```javascript
FLOAT32_CBRT_EPSILON = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-cbrt-eps@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var FLOAT32_CBRT_EPSILON = require( 'path/to/vendor/umd/constants-float32-cbrt-eps/index.js' )
```
