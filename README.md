...
```javascript
FLOAT32_CBRT_EPS = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-cbrt-eps@v0.0.7-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-cbrt-eps@v0.0.7-umd/browser.js"></script>
```
